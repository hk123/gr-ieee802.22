...
this an IEEE 802.22 a/g/p transceiver for GNU Radio v3.7. Over the air, I tested it with the Ettus USRP N210 with XCVR2450 and CBX daughterboards. For interoperability tests I use mainly an Atheros (ath5k) WiFi card. The code can also be used for packet error rate simulations.
...
## Installation of gr-ieee802-22

To actually install the blocks do

    git clone git://github.com/bastibl/gr-ieee802-22.git
    cd gr-ieee802-22
    mkdir build
    cd build
    cmake ..
...
If GRC complains that it can't find some blocks (other than performance counters and hierarchical blocks) like
    ...
    >>> Error: Block key "ieee802_22_ofdm_mac" not found in Platform - grc(GNU Radio Companion)
...
- Did you compile GNU Radio and gr-ieee802-22 in release mode?
